...
"")
        ...
        self.mode_one_button.setStyleSheet("QPushButton#mode_one_button{\n"
"   padding: 10px;\n"
"   background-color:white;\n"
"}\n"
"\n"
"QPushButton:hover#mode_one_button {\n"
"background-color:rgb(215,214,213);\n"
"}\n"
"")
        ...
        self.mode_two_button.setStyleSheet("QPushButton#mode_two_button{\n"
"   padding: 10px;\n"
"   background-color:white;\n"
"}\n"
"\n"
"QPushButton:hover#mode_two_button {\n"
"background-color:rgb(215,214,213);\n"
"}")
        ...
        self.mode_three_button.setStyleSheet("QPushButton#mode_three_button{\n"
"   padding: 10px;\n"
"   background-color:white;\n"
"}\n"
"\n"
"QPushButton:hover#mode_three_button {\n"
"background-color:rgb(215,214,213);\n"
"}")
        ...
        self.camera_button.setStyleSheet("QPushButton#camera_button{\n"
"   padding: 10px;\n"
"   background-color:white;\n"
"}\n"
"\n"
...
"}")
        ...
        self.Kmeans_para = QtWidgets.QLabel(self.frame)
        self.Kmeans_para.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.Kmeans_para.setObjectName("Kmeans_para")
        self.gridLayout.addWidget(self.Kmeans_para, 10, 0, 1, 1)
        self.Background_darkness_para = QtWidgets.QLabel(self.frame)
        self.Background_darkness_para.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.Background_darkness_para.setObjectName("Background_darkness_para")
        self.gridLayout.addWidget(self.Background_darkness_para, 5, 0, 1, 1)
        self.Background_darkness_slider = QtWidgets.QSlider(self.frame)
        self.Background_darkness_slider.setMinimum(0)
        self.Background_darkness_slider.setMaximum(100)
        self.Background_darkness_slider.setPageStep(1)
        self.Background_darkness_slider.setProperty("value", 1)
        self.Background_darkness_slider.setOrientation(QtCore.Qt.Horizontal)
        self.Background_darkness_slider.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.Background_darkness_slider.setTickInterval(5)
        self.Background_darkness_slider.setObjectName("Background_darkness_slider")
        self.gridLayout.addWidget(self.Background_darkness_slider, 5, 1, 1, 2)
        ...
        self.Kmeans_display = QtWidgets.QLabel(self.frame)
        self.Kmeans_display.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.Kmeans_display.setText("")
        self.Kmeans_display.setObjectName("Kmeans_display")
        self.gridLayout.addWidget(self.Kmeans_display, 10, 3, 1, 1)
        self.Background_darkness_display = QtWidgets.QLabel(self.frame)
        self.Background_darkness_display.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.Background_darkness_display.setText("")
        self.Background_darkness_display.setObjectName("Background_darkness_display")
        self.gridLayout.addWidget(self.Background_darkness_display, 5, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.Thres_two_slider, 15, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.AT_three_para, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.GBlur_slider, 11, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.Thres_one_slider, 14, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.GBlur_para, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Thres_one_display, 14, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.Thres_two_para, 15, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.Thres_two_display, 15, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.AT_three_display, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.Thres_one_para, 14, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.G_blur_display, 11, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.AT_three_slider, 7, 1, 1, 2)
        ...
        self.Kmeans_slider = QtWidgets.QSlider(self.frame)
        self.Kmeans_slider.setMinimum(0)
        self.Kmeans_slider.setMaximum(200)
        self.Kmeans_slider.setPageStep(1)
        self.Kmeans_slider.setProperty("value", 1)
        self.Kmeans_slider.setOrientation(QtCore.Qt.Horizontal)
        self.Kmeans_slider.setTickPosition(QtWidgets.QSlider.TicksBelow)
        self.Kmeans_slider.setTickInterval(5)
        self.Kmeans_slider.setObjectName("Kmeans_slider")
        self.gridLayout.addWidget(self.Kmeans_slider, 10, 1, 1, 2)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Kmeans_para.setText(_translate("MainWindow", "K-means Tol:"))
        self.Background_darkness_para.setText(_translate("MainWindow", "BG.Darkness:"))
